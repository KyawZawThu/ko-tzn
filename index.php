	...
	<div class="container mt-5 px-5">
		...
		<div class="row">
			...
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
				<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				  	<img src="<?= $cphoto; ?>" class="card-img-top img-fluid w-75 h-25" alt="..." >
				  	<div class="card-body">
		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a href="#" class="addtocartBtn text-decoration-none" data-id="<?=$di_id?>" data-code="<?=$di_code?>" data-name="<?=$di_name?>" data-photo="<?=$di_photo?>" data-price="<?=$di_price?>" data-discount="<?=$di_discount?>">Add to Cart</a>
		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a href="#" class="addtocartBtn text-decoration-none" data-id="<?=$sa_id?>" data-code="<?=$sa_code?>" data-name="<?=$sa_name?>" data-photo="<?=$sa_photo?>" data-price="<?=$sa_price?>" data-discount="<?=$sa_discount?>">Add to Cart</a>
		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a href="#" class="addtocartBtn text-decoration-none" data-id="<?=$ra_id?>" data-code="<?=$ra_code?>" data-name="<?=$ra_name?>" data-photo="<?=$ra_photo?>" data-price="<?=$ra_price?>" data-discount="<?=$ra_discount?>">Add to Cart</a>
	    ...
	    <section class="customer-logos slider mt-5">
	      		...
	      		<?php 
	      			...
	      			$stmt->execute();
	      			$brandfoot=$stmt->fetchAll();
	      			foreach ($brandfoot as $brandall) {
	      				$photo=$brandall['photo'];
	      				$name=$brandall['name'];
